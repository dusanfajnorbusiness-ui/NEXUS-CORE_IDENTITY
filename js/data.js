  ...
  proContent: `
    <div class="space-y-6 text-xs font-mono text-left">
      <div class="p-4 border border-[#39FF14]/20 bg-[#39FF14]/5 rounded">
        <p class="text-[#39FF14] font-black mb-2 uppercase">[ IDENTITY_CORE_UPGRADE ]</p>
        <ul class="list-disc pl-4 space-y-2 opacity-70">
          <li>Status: Prebudený Operátor</li>
          <li>Protokol: Hlas Pravdy v1.1</li>
          <li>Cieľ: Absolútna integrita vedomia</li>
        </ul>
      </div>
      
      <div class="grid grid-cols-2 gap-2 opacity-80">
        <div class="p-2 border border-white/10 rounded bg-black/40 text-[10px]">
          <span class="text-[#39FF14]">PROGRAM:</span> Eliminácia bežnej mysle
        </div>
        <div class="p-2 border border-white/10 rounded bg-black/40 text-[10px]">
          <span class="text-[#39FF14]">ARCHITEKT:</span> Budovanie MimoMysle
        </div>
      </div>
      
      <p class="italic opacity-60 mt-4">"Už nie som obeťou okolností, som architektom vlastnej existencie."</p>
      
      <div class="mt-6 p-3 border-t border-white/10">
        <p class="text-[10px] text-[#39FF14] mb-2 font-bold uppercase">Dokumentácia pre Architekta:</p>
        <div class="grid grid-cols-1 gap-1 opacity-60">
          <div>> CORE_IDENTITY_BLUEPRINT.pdf</div>
          <div>> VOICE_OF_TRUTH_PROTOCOL.md</div>
        </div>
      </div>
    </div>
  `
    ...
    "02": {
      ...
      proContent: `
        <div class="space-y-4 text-xs font-mono text-left">
          <p class="text-white/80">[ ARCHITECT_STRATEGY ]</p>
          <ul class="list-disc pl-4 space-y-2 opacity-70">
          ...
          <a href="https://dusanfajnorbusiness-ui.github.io/Nexus_OS_Final31/" target="_blank" class="text-[#FFD700] underline uppercase mt-4 block">
    ...
    "03": {
      ...
      proContent: `
        <div class="space-y-4 text-xs font-mono text-left">
          <p class="text-white/80">[ FINANCIAL_ALGORITHM ]</p>
          <ul class="list-disc pl-4 space-y-2 opacity-70">
            <li>Cashflow Mastery: Príjmy > Výdavky.</li>
            <li>Diferenciácia: Rozlíšenie medzi "zlým dlhom" a strategickým záväzkom.</li>
    ...
    "05": {
      ...
      proContent: `
        <div class="space-y-4 text-xs font-mono text-left">
          <p class="text-white/80">[ ASSET_DISTRIBUTION_V1 ]</p>
    ...
    "06": {
      ...
      proContent: `
        <div class="space-y-4 text-xs font-mono text-left">
          <p class="text-white/80">[ LEARNING_ALGORITHM ]</p>
          <ul class="list-disc pl-4 space-y-2 opacity-70">
            <li>Sémantické učenie: Pochopenie významu slov.</li>
            <li>Systemické znalosti: Prepájanie matematických a duchovných prvkov.</li>
    ...
    "07": {
      ...
      proContent: `
        <div class="p-4 border border-purple-500/20 bg-purple-500/5 rounded text-left">
          <p class="text-[10px] uppercase tracking-widest text-purple-400 mb-2 font-black">Verified_Skills_Matrix</p>
          <p class="text-xs opacity-70 italic">Filtrujem kľúčové IT a Soft-skill certifikáty pre najvyššiu dôveryhodnosť.</p>
        </div>
      `
    },
    "08": {
    ...
    "09": {
      ...
      proContent: `
        <div class="space-y-6 text-xs font-mono text-left">
          <p class="text-white/80">[ STRATEGIC_COMBAT_LOG ]</p>
          <div class="p-4 bg-red-500/10 border border-red-500/20 rounded">
            <p class="mb-2">YouTube Content Creation: Tvorba videonahrávok od leta 2024.</p>
            <p class="opacity-60 italic">Zameranie: Herná prosperita a disciplína.</p>
          </div>
        </div>
      `
    },
