      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="p-4 border border-white/10 bg-black/40 rounded-lg group hover:border-[#8A2BE2]/50 transition-colors">
          <div class="flex justify-between items-center mb-3">
            <span class="text-[#8A2BE2] text-[10px] font-black uppercase tracking-widest">[ ITnetwork_Core ]</span>
            <span class="text-[7px] opacity-30 italic font-bold">VERIFIED_2024</span>
          </div>
          <div class="space-y-1.5 text-[8px] opacity-80 uppercase tracking-tighter">
            <div class="flex justify-between"><span>C# .NET Konstrukce</span><span class="text-[#8A2BE2]">OK</span></div>
            <div class="flex justify-between"><span>MS Office Mastery</span><span class="text-[#8A2BE2]">OK</span></div>
            <div class="flex justify-between"><span>UX & Responsive Design</span><span class="text-[#8A2BE2]">OK</span></div>
          </div>
        </div>

        <div class="p-4 border border-white/10 bg-black/40 rounded-lg group hover:border-[#8A2BE2]/50 transition-colors">
          <div class="flex justify-between items-center mb-3">
            <span class="text-[#8A2BE2] text-[10px] font-black uppercase tracking-widest">[ Skillmea_Flow ]</span>
            <span class="text-[7px] opacity-30 italic font-bold">VERIFIED_2025</span>
          </div>
          <div class="space-y-1.5 text-[8px] opacity-80 uppercase tracking-tighter">
            <div class="flex justify-between"><span>WebRebel (HTML/CSS/JS)</span><span class="text-[#8A2BE2]">OK</span></div>
            <div class="flex justify-between"><span>Todoist Mastery</span><span class="text-[#8A2BE2]">OK</span></div>
            <div class="flex justify-between"><span>Time Management v5.0</span><span class="text-[#8A2BE2]">OK</span></div>
          </div>
        </div>
      </div>
    </div>
